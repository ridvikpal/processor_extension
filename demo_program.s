...
mv r1, =KEY_ADDRESS
ld r1, [r1] // get whatever is stored in the keys
//st r1, [r4]
lsr r1, #1 // make key 1 the lsb
and r1, #1 // only get the lsb
cmp r1, #0 // check if the lsb is 1
beq KEY_3

CONTINUE_1: mv r1, =KEY_ADDRESS
ld r1, [r1]
//st r1, [r4]
lsr r1, #2 // make key 2 the lsb
and r1, #1 // only get the lsb
cmp r1, #0 // check if the lsb is 1
beq KEY_4

CONTINUE_2: mv r1, =KEY_ADDRESS
ld r1, [r1]
//st r1, [r4]
lsr r1, #3 // make key 3 the lsb
and r1, #1 // only get the lsb
cmp r1, #0 // check if the lsb is 1
beq KEY_5
